...
//------------------------------------------------------------------------------
void CColorFastaStream::ProcessDefline(void)
{
    const char * SEPS = " \t";
...
//------------------------------------------------------------------------------
inline std::string CColorFastaStream::Color2NCBI2NA( const std::string & cstr )
{
...
//------------------------------------------------------------------------------
void CColorFastaStream::ProcessLine(void)
{
    switch( state_ ) {
        case E_START:
...
//------------------------------------------------------------------------------
bool CColorFastaStream::Next(void)
{
